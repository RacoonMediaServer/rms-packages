...
type GetStreamUriRequest struct {
	...
	Transport *media.Transport `protobuf:"varint,2,opt,name=transport,proto3,enum=media.Transport,oneof" json:"transport,omitempty"`
}
...
func (x *GetStreamUriRequest) GetTransport() media.Transport {
...
func (x *UriResponse) GetTransport() media.Transport {
	if x != nil {
		return x.Transport
	}
	return media.Transport(0)
...
func (x *GetRecordingUriRequest) GetTransport() media.Transport {
	if x != nil && x.Transport != nil {
		return *x.Transport
	}
	return media.Transport(0)
...
var file_cctv_backend_proto_rawDesc = []byte{
	...
	0x28, 0x0e, 0x32, 0x10, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x54,
...
var file_cctv_backend_proto_goTypes = []interface{}{
	...
	(media.Transport)(0),               // 12: media.Transport
	(*emptypb.Empty)(nil),              // 13: google.protobuf.Empty
}
var file_cctv_backend_proto_depIdxs = []int32{
	12, // 0: GetStreamUriRequest.transport:type_name -> media.Transport
	12, // 1: UriResponse.transport:type_name -> media.Transport
	12, // 2: GetRecordingUriRequest.transport:type_name -> media.Transport
